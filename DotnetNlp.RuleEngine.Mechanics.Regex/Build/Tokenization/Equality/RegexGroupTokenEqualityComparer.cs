...
namespace DotnetNlp.RuleEngine.Mechanics.Regex.Build.Tokenization.Equality;

internal sealed class RegexGroupTokenEqualityComparer : IEqualityComparer<RegexGroupToken>
{
    public static readonly RegexGroupTokenEqualityComparer Instance = new();
    ...
    {
        public static readonly BranchTokenEqualityComparer Instance = new();
    ...
    {
        public static readonly BranchItemTokenEqualityComparer Instance = new();
    ...
    {
        public static readonly QuantifiableBranchItemTokenEqualityComparer Instance = new();
        ...
        {
            var hashCode = QuantifiableTokenEqualityComparer.Instance.GetHashCode(obj.Quantifiable);
    ...
    {
        public static readonly MarkerTokenEqualityComparer Instance = new();
    ...
    {
        public static QuantifiableTokenEqualityComparer Instance = new();
    ...
    {
        public static readonly AnyLiteralTokenEqualityComparer Instance = new();
    ...
    {
        public static readonly LiteralSetTokenEqualityComparer Instance = new();
    ...
    {
        public static LiteralSetMemberTokenEqualityComparer Instance = new();
    ...
    {
        public static readonly LiteralTokenEqualityComparer Instance = new();
    ...
    {
        public static readonly PrefixTokenEqualityComparer Instance = new();
    ...
    {
        public static readonly InfixTokenEqualityComparer Instance = new();
    ...
    {
        public static readonly SuffixTokenEqualityComparer Instance = new();
    ...
    {
        public static readonly RuleReferenceTokenEqualityComparer Instance = new();
        ...
        {
            var hashCode = obj.RuleName.GetHashCode();
    ...
    {
        public static NerTokenEqualityComparer Instance = new();
        ...
        {
            var hashCode = obj.VariableName.GetHashCode();
    ...
    {
        public static QuantifierTokenEqualityComparer Instance = new();
