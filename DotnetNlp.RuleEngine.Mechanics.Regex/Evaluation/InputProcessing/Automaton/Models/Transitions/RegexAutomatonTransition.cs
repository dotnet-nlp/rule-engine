...
using DotnetNlp.RuleEngine.Mechanics.Regex.Evaluation.InputProcessing.Graph;

namespace DotnetNlp.RuleEngine.Mechanics.Regex.Evaluation.InputProcessing.Automaton.Models.Transitions;
