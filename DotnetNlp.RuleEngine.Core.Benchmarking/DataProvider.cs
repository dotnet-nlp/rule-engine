...
public static class DataProvider
{
    ...
    {
        public static readonly Dictionary<string, string> RuleSets = new()
        {
            {
                "ner.time",
