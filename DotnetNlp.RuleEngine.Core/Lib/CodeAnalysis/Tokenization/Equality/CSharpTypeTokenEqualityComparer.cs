...
namespace DotnetNlp.RuleEngine.Core.Lib.CodeAnalysis.Tokenization.Equality;

public sealed class CSharpTypeTokenEqualityComparer : IEqualityComparer<ICSharpTypeToken>, IEqualityComparer
{
    public static readonly CSharpTypeTokenEqualityComparer Instance = new();
    ...
    {
        public static readonly ResolvedCSharpTypeTokenEqualityComparer Instance = new();
    ...
    {
        public static readonly ClassicCSharpTypeTokenEqualityComparer Instance = new();
    ...
    {
        public static readonly CSharpTypeNameWithNamespaceTokenEqualityComparer Instance = new();
    ...
    {
        public static readonly TupleCSharpTypeTokenEqualityComparer Instance = new();
    ...
    {
        public static readonly CSharpTupleItemTokenEqualityComparer Instance = new();
    ...
    {
        public static readonly CSharpIdentifierTokenEqualityComparer Instance = new();
