...
using RuleEngine.Core.Tests.Fixtures;
using RuleEngine.Core.Tests.Helpers;
using RuleEngine.Core.Tests.Helpers.Dummy;
using RuleEngine.Mechanics.Peg.Build.Tokenization.Equality;
...
internal sealed class RuleSetTokenizerTests
{
    ...
    {
        var ruleSetToken = _tokenizer.Tokenize(ruleSet, null, true);
    ...
    {
        var ruleSetContainer = RuleSetsByKey[ruleSetKey];
        var ruleSetToken = _realTokenizer.Tokenize(ruleSetContainer.Definition, null, true);
    ...
    {
        var exception = Assert.Throws<RuleEngineTokenizationException>(
            () => _tokenizer.Tokenize(ruleSet, null, true)
        );
    ...
    {
        return RuleSetsByKey.Keys.ToArray();
    }
    ...
    {
        public static readonly DummyPatternTokenEqualityComparer Instance = new();
