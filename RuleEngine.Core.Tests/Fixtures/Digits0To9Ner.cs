        ...
        new RuleSetToken(
            ...
            new []
            {
                new RuleToken(
                    ...
                    new BodyBasedProjectionToken("{ return RuleEngine.Core.Tests.Helpers.Pick.OneOf(n_0, n_1, n_2, n_3, n_4, n_5, n_6, n_7, n_8, n_9); }")
                ),
                new RuleToken(
                    null,
                    new ClassicCSharpTypeToken(new CSharpTypeNameWithNamespaceToken("System.String"), Array.Empty<ICSharpTypeToken>()),
