//
// IronMeta PegSyntaxMatcher Parser; Generated 2022-06-27 19:57:23Z UTC
//
...
namespace DotnetNlp.RuleEngine.Mechanics.Peg.Build.Tokenization.Grammar
{
    ...
    public partial class PegSyntaxMatcher : Matcher<char, IToken>
    {
        ...
        public void RuleReference(_PegSyntaxMatcher_Memo _memo, int _index, _PegSyntaxMatcher_Args _args)
        {
            ...
            _r5 = _MemoCall(_memo, "_cSharpSyntaxMatcher.CSharpNamespace", _index, _cSharpSyntaxMatcher.CSharpNamespace, null);
        ...
        public void RuleObjectPropertyArgument(_PegSyntaxMatcher_Memo _memo, int _index, _PegSyntaxMatcher_Args _args)
        {
            ...
            {
                _memo.Results.Pop();
                _memo.Results.Push( new _PegSyntaxMatcher_Item(_r0.StartIndex, _r0.NextIndex, _memo.InputEnumerable, _Thunk(_IM_Result => { return new ChainedMemberAccessArgumentToken(((CSharpChainedMemberAccessToken) memberAccess.Results.Single()).Value); }, _r0), true) );
            }
