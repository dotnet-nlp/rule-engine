...
namespace DotnetNlp.RuleEngine.Mechanics.Peg.Build.Tokenization.Equality;

public sealed class PegGroupTokenEqualityComparer : IEqualityComparer<PegGroupToken>
{
    public static readonly PegGroupTokenEqualityComparer Instance = new();
    ...
    {
        public static readonly LookaheadTokenEqualityComparer Instance = new();
    ...
    {
        public static readonly QuantifiableTokenEqualityComparer Instance = new();
    ...
    {
        public static readonly LiteralSetMemberTokenEqualityComparer Instance = new();
    ...
    {
        public static readonly QuantifierTokenEqualityComparer Instance = new();
