...
internal sealed class ErrorIndexHelperTests
{
    ...
    )
    {
        ...
        new ErrorIndexHelper("\r\n").FillExceptionData(data, source, null, errorIndex);
        ...
        var hasErrorCharacter = data.Contains("error_character");
        ...
        var hasErrorContext = data.Contains("error_context");
