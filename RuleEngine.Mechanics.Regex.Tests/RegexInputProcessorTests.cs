...
using RuleEngine.Mechanics.Regex.Evaluation.InputProcessing;
using RuleEngine.Mechanics.Regex.Tests.Fixtures;
using RuleEngine.Mechanics.Regex.Tests.Helpers;
...
internal sealed class RegexInputProcessorTests
{
    ...
    )
    {
        ...
        var fullMatches = results.ExcludeEmptyMatches().GetFullMatches();
    ...
    private static IRuleSpace CreateRuleSpace(
        Dictionary<string, string> rules,
        bool caseSensitive,
        OptimizationLevel optimizationLevel
    )
    {
        var regexpMechanics = StaticResources.RegexMechanics(optimizationLevel);

        var ruleSpaceSource = new RuleSpaceSource<RegexGroupToken>(
